...
public class BuildCommands {
    ...
    public PropertiesProvider newPropertiesProvider(PropertyType propertyType) {
        ...
        PropertiesProvider envSpecificPropertiesProvider = cache(new EnvSpecificPropertiesProvider(fileBasedPropertiesProvider, environmentProvider, configRoot, componentsDir));
