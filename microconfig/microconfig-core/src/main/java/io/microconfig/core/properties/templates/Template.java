...
class Template {
    ...
    String resolvePlaceholders(String currentComponent, PropertyResolver propertyResolver, Pattern pattern) {
    ...
    private void doResolve(Matcher m, StringBuffer result, PropertyResolver propertyResolver, String currentComponent) {
    ...
    private String resolveValue(String placeholder, String currentComponent, PropertyResolver propertyResolver) {
    ...
    private String doResolve(String currentComponent, PropertyResolver propertyResolver, String placeholder) {
