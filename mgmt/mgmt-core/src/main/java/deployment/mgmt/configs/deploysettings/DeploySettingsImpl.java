...
public class DeploySettingsImpl implements DeploySettings {
    ...
    public Artifact getMgmtArtifactFromConfigs() {
        ...
        String version = configFormat.read(mgmtVersionFile).get(MGMT_VERSION_PROPERTY);
    ...
    public void setNexusCredentials(String credentials) {
        if (!credentials.contains(":")) {
            throw new IllegalArgumentException("NexusClasspathStrategy credentials must contains login and password separated by ':'. Example user:secret");
        }
